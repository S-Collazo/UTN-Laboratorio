...
class FormMenuA(Form):
    def __init__(self,name,master_surface,x,y,w,h,background_color,border_color,active):
        ...
        self.pb1 = ProgressBar(master_surface=self,x=500,y=50,w=240,h=50,background_color=None,border_color=None,background_image=PATH_RECURSOS + "/gui/set_gui_01/Comic_Border/Bars/Bar_Background01.png",image_progress=PATH_RECURSOS + "/gui/set_gui_01/Comic_Border/Bars/Bar_Segment05.png",value = 3, value_max=8)
