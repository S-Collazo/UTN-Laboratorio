...
class LevelSelector(Form):
    def __init__(self,name,master_surface,x,y,w,h,background_color,border_color,active):
        ...
        self.lvl1 = Button(master_surface=self,x=self.menu_x,y=10,w=150,h=100,background_color=None,border_color=None,background_image=PATH_RECURSOS + "/gui/set_gui_01/Paper/Buttons/Button_XL_06.png",on_click=self.on_click_lvl1,on_click_param=1,text="Nivel 1",font="Verdana",font_size=30,font_color=WHITE)
        self.lvl2 = Button(master_surface=self,x=self.menu_x + 160,y=10,w=150,h=100,background_color=None,border_color=None,background_image=PATH_RECURSOS + "/gui/set_gui_01/Paper/Buttons/Button_XL_06.png",on_click=self.on_click_lvl2,on_click_param=2,text="Nivel 2",font="Verdana",font_size=30,font_color=WHITE)
        self.lvl3 = Button(master_surface=self,x=self.menu_x + 320,y=10,w=150,h=100,background_color=None,border_color=None,background_image=PATH_RECURSOS + "/gui/set_gui_01/Paper/Buttons/Button_XL_06.png",on_click=self.on_click_lvl3,on_click_param=3,text="Nivel 3",font="Verdana",font_size=30,font_color=WHITE)
        ...
        self.button_exit = Button(master_surface=self,x=self.menu_x + 50,y=(self.h - 50),w=150,h=50,background_color=None,border_color=None,background_image=PATH_RECURSOS + "/gui/set_gui_01/Paper/Buttons/Button_M_02.png",on_click=self.on_click_button_exit,on_click_param="main",text="Volver",font="Verdana",font_size=20,font_color=BLACK)
