...
class WinMain(Form):
    def __init__(self,player,time,name,master_surface,x,y,w,h,background_color,border_color,active,spawner=False,boss=False):
        ...
        self.button_restart = Button(master_surface=self,x=self.menu_x + 50,y=600,w=200,h=50,background_color=None,border_color=None,background_image=PATH_RECURSOS + "/gui/set_gui_01/Paper/Buttons/Button_L_08.png",on_click=self.on_click_button_restart,on_click_param=None,text="Reiniciar Nivel",font="Verdana",font_size=20,font_color=WHITE)
